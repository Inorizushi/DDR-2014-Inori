...
t[#t+1] = Def.ActorFrame {
	...
	---- DOOR OPEN > CLOSE  CLOSE > OPEN
		...
		InitCommand=cmd(x,SCREEN_CENTER_X;y,-360;);
		OnCommand=cmd(linear,0.25;y,0;sleep,1.80;linear,0.45;y,-380);
	};
	...
	LoadActor("../DDR_logo_Doors.png")..{
	InitCommand=cmd(x,SCREEN_CENTER_X;y,0;diffuse,color("1,1,1,0.5");blend,Blend.Add;);
	OnCommand=cmd(diffusealpha,0;sleep,0.3;linear,0.05;diffusealpha,1;linear,0.05;diffusealpha,0);
};
