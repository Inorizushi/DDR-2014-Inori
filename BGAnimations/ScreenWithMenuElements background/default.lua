return Def.ActorFrame{
	...
	LoadActor( "Effectbg_ddr2013.png" )..{
		InitCommand=cmd(zoom,1;x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y;diffusealpha,0.3;blend,Blend.Add;;setsize,1476,1476);
	...
	LoadActor( "Effectbg_ddr2013.png" )..{
		InitCommand=cmd(blend,'BlendMode_Add';zoom,0.9;x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y;diffusealpha,0.5;setsize,1476,1476);
	...
	LoadActor( "Effectbg_ddr2013.png" )..{
		InitCommand=cmd(rotationz,90;zoom,1.3;x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y;diffusealpha,0.3;blend,Blend.Add;;setsize,1476,1476);
